...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <CommandPrimitive.Input
      ...
      ref={ref}
      className={cn(
        "flex input h-11 w-full p-12 rounded-md bg-transparent py-3 text-sm outline-none placeholder:text-slate-400 disabled:cursor-not-allowed disabled:opacity-50 dark:text-slate-50",
        className
      )}
      {...props}
    />
